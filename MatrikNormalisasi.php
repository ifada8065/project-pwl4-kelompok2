                                    ...
                                    <tbody>
                                        <?php
                                         //Lakukan Normalisasi dengan rumus pada langkah 2
                                          ...
                                          $crMin = mysqli_query("SELECT min(c5) as minK5 FROM kriteria where kategori='".$_POST['kategori']."'");
                                            $min = mysqli_fetch_array($crMin);

                                          //Hitung Normalisasi tiap Elemen
                                            include 'admin/config/config.php';
                                            $kriteria1 = mysqli_query("select * from kriteria where kategori='".$_POST['kategori']."'");
                                            $q=0;
